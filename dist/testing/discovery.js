...
export class ExtensionTestDiscovery {
    static TEST_FILE_PATTERN = 'src/extensions/*/tests/index.ts';
     ...
     */
    static getAllTestSuites(filter) {
     ...
     */
    static async loadTestSuite(extensionPath) {
     ...
     */
    static validateTestSuite(suite) {
        const errors = [];
     ...
     */
    static async discoverTestFiles(basePath) {
     ...
     */
    static async findTestFiles(dir) {
        const testFiles = [];
        try {
     ...
     */
    static async hasTestFiles(extensionPath) {
     ...
     */
    static async loadTestFile(filePath) {
        try {
     ...
     */
    static filterTestSuites(suites, filter) {
     ...
     */
    static validateTestSuiteMetadata(metadata) {
        const errors = [];
     ...
     */
    static isValidExtensionInstance(instance) {
     ...
     */
    static async getDiscoverySummary() {
        const testFiles = await this.discoverTestFiles();
