...
export declare const TEST_TYPES: {
    readonly ExtensionTestSuite: symbol;
    readonly TestHarness: symbol;
    readonly MockMCPMon: symbol;
    readonly IntegrationContext: symbol;
    readonly E2EContext: symbol;
    readonly TestLogger: symbol;
    readonly MessageCapture: symbol;
    readonly ExtensionLoader: symbol;
};
/**
