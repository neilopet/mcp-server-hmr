...
Deno.test("Config launcher - setup preserves other servers", async () => {
  ...
  assertExists(modifiedConfig.mcpServers["server-two-original"], "server-two-original should exist");
  assertEquals(
...
Deno.test("Config launcher - setup all preserves all servers", async () => {
  ...
  assertExists(modifiedConfig.mcpServers["stdio-server-original"], "stdio-server-original should exist");
  assertExists(modifiedConfig.mcpServers["another-stdio-original"], "another-stdio-original should exist");
